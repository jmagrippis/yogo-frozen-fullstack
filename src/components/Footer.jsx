...
import { cyan500, white, darkWhite } from 'material-ui/styles/colors'
  ...
  render () {
    ...
    return (
      <footer className={className ? className + ' ' : '' + css(styles.container)}>
        <p>{footerData.madeWith} <ActionFavorite color={white} style={{ height: '1rem', width: '1rem' }} /> {footerData.in} Manchester</p>
